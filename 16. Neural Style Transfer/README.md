...
```
    ...
    <matplotlib.image.AxesImage at 0x7fd037333908>
...
def compute_content_cost(a_C, a_G):
    ...
    J_content = (1/(4 * n_W * n_H * n_C)) * tf.reduce_sum(tf.square(tf.subtract(a_C, a_G)))
    ### END CODE HERE ###
...
```
    ...
    <matplotlib.image.AxesImage at 0x7fd0340814a8>
...
```
    ...
    <matplotlib.image.AxesImage at 0x7fd02c686be0>
...
```
    ...
    <ipython-input-38-aed364014da4> in <module>()
    ----> 1 model_nn(sess, generated_image)
    

    <ipython-input-37-2e84fffe243a> in model_nn(sess, input_image, num_iterations)
